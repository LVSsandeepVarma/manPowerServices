        ...
        <section className="nk-section pt-120 pt-lg-180">
          ...
          <div className="container">
            <div className="nk-block-head md">
              <div className="nk-section-head" style={{paddingBottom:"0px"}}>
                <nav>
                  ...
                  <div className="nk-entry"  >
                    <div className="pb-5"id="headingOne" >
                      ...
                      <p className="fs-16">
                        ...
                        tristique sem. Etiam cras turpis adipiscing molestie
                        elit habitasse. Amet, maecenas cras imperdiet nulla
                        blandit interdum dictum. Cras nunc, risus aliquet
                        facilisi. Ullamcorper posuere porta placerat hendrerit
                        eget neque risus. In gravida feugiat nisl ipsum sed
                        aliquam. Consectetur aliquet vestibulum sit a id. Sed
                        vitae nunc proin feugiat blandit scelerisque ac
                        ultrices. Nulla malesuada viverra eros, sem lectus.
                        Dolor sed ullamcorper magna nibh aliquam mauris
                        fermentum, elit. Nec in augue vel in tellus. Consectetur
                        nunc iaculis donec scelerisque.
                      </p>
                      <p className="fs-16">
                      ...
                      <p className="fs-16">
                        ...
                        rhoncus, sit sit convallis viverra. Diam proin pretium
                        eu odio nisi, proin. Ultrices eu in condimentum aliquam.
                      </p>
                      <p className="fs-16">
                        ...
                        facilisis in. Euismod vel pharetra pretium gravida amet.
                        Tincidunt tortor arcu in mollis fermentum volutpat
                        fringilla. Quis elementum feugiat ac nulla suspendisse
                        ornare euismod. Lorem tincidunt maecenas sed feugiat
                        massa commodo sed malesuada convallis. Tortor at mattis
                        risus, integer pretium, dui, faucibus.
                      </p>
                    </div>
                    ...
                    <div className="pb-5" id="headingthree">
                      ...
                      <p className="fs-16">
                        ...
                        videos, audio clips, written posts and comments,
                        software, scripts, graphics, and interactive features
                        (collectively, “Content”) generated, provided, or
                        otherwise made accessible or available by NioLand on the
                        Platform are protected by copyrights, trademarks,
                        service marks, patents, trade secrets or other
                        proprietary rights and laws. All such Content is the
                        proprietary property of NioLand with all rights
                        ...
                        such Content. For clarity, the foregoing restrictions
                        apply to third party trademarks, which may be used by us
                        on the Platform under license. Unless otherwise noted,
                        we are not affiliated with or endorsed by the owner of
                        any third-party trademarks displayed.
                      </p>
                      <p className="fs-16">
                        ...
                        display locally) Content solely for purposes of using
                        the Platform or receiving services. The Platform may
                        allow you to copy or download certain Content, but
                        please remember that even where these functionalities
                      ...
                      <p className="fs-16">
                        ...
                        generality of the foregoing, you acknowledge that
                        NioLand may disclose and transfer any such information
                        that you provide (i) to its affiliates, agents or
                        service providers; (ii) to any other person or entity
                        with your consent; or (iii) if we have a right or duty
                        to disclose or are permitted or compelled to disclose
